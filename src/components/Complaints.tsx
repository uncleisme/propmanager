...
const Complaints: React.FC = () => {
  ...
  const workOrderTitles = [
    ...
    { value: 'PLUMBING_ISSUE', label: 'Plumbing Issue', category: 'Facilities / Maintenance' },
    { value: 'ELECTRICAL_ISSUE', label: 'Electrical Issue', category: 'Facilities / Maintenance' },
    { value: 'AIR_CONDITIONING', label: 'Air Conditioning', category: 'Facilities / Maintenance' },
    { value: 'LIGHTING_PROBLEM', label: 'Lighting Problem', category: 'Facilities / Maintenance' },
    { value: 'DOOR_OR_LOCK_REPAIR', label: 'Door or Lock Repair', category: 'Facilities / Maintenance' },
    { value: 'FURNITURE_REPAIR', label: 'Furniture Repair', category: 'Facilities / Maintenance' },
    { value: 'CLEANING_REQUEST', label: 'Cleaning Request', category: 'Facilities / Maintenance' },
    { value: 'PEST_CONTROL', label: 'Pest Control', category: 'Facilities / Maintenance' },
    { value: 'PAINTING_REQUEST', label: 'Painting Request', category: 'Facilities / Maintenance' },
    // IT / Technical
    { value: 'COMPUTER_ISSUE', label: 'Computer Issue', category: 'IT / Technical' },
    { value: 'INTERNET_PROBLEM', label: 'Internet Problem', category: 'IT / Technical' },
    { value: 'SOFTWARE_SUPPORT', label: 'Software Support', category: 'IT / Technical' },
    { value: 'PRINTER_ISSUE', label: 'Printer Issue', category: 'IT / Technical' },
    { value: 'EMAIL_OR_ACCOUNT', label: 'Email or Account', category: 'IT / Technical' },
    { value: 'NETWORK_PROBLEM', label: 'Network Problem', category: 'IT / Technical' },
    // Administrative / General Office
    { value: 'SUPPLY_REQUEST', label: 'Supply Request', category: 'Administrative / General Office' },
    { value: 'MEETING_ROOM_SETUP', label: 'Meeting Room Setup', category: 'Administrative / General Office' },
    { value: 'KEYCARD_ACCESS', label: 'Keycard Access', category: 'Administrative / General Office' },
    { value: 'MOVING_ASSISTANCE', label: 'Moving Assistance', category: 'Administrative / General Office' },
