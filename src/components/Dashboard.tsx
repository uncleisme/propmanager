...
import { Users, FileText, Award, AlertTriangle, Calendar, TrendingUp, UserCheck, Truck, Building2, Box, BarChart3, Droplet, Zap, ArrowUpRight, ArrowDownRight, Wrench, ChevronDown, ChevronRight, Plus, LogOut } from 'lucide-react';
...
const Dashboard: React.FC<DashboardProps> = ({ user, onLogout }) => {
  ...
  const [avatarMenuOpen, setAvatarMenuOpen] = React.useState(false); // For avatar dropdown
