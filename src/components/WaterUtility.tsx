  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Water Utility</h1>
          <p className="text-gray-600">Track and manage water consumption</p>
        </div>
        <button
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-bold text-gray-900">
                  {modalType === 'add' ? 'Add Water Entry' : 'Edit Water Entry'}
                </h2>
                <button
